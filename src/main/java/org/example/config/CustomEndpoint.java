...
public enum CustomEndpoint {
    ...
    TEST("direct:test", "azureServiceBus:queue:siag-sa-03-procedimenti-creaprotocollo-queue"),
    TEST_CONSUMPTION("direct:test", "azureServiceBus:queue:test-zupit-michele-segata-consumption");
