...
public class AnotherJmsSender {
    public static void main(String[] args) throws Exception {
        ...
        Queue queue = (Queue) ctx.lookup("java:/jms/queue/testQueue3");
        ...
        TextMessage message = session.createTextMessage("Messaggio di test da Java alla coda 3!");
        producer.send(message);

        System.out.println("Messaggio inviato con successo alla coda 3!");
